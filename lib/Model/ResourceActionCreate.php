...
/**
 * ResourceActionCreate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResourceActionCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResourceActionCreate';
    ...
    */
    ...
    public function setKey($key)
    {
        ...
        if ((!preg_match("/^[A-Za-z0-9\\-_]+$/", ObjectSerializer::toString($key)))) {
            throw new \InvalidArgumentException("invalid value for \$key when calling ResourceActionCreate., must conform to the pattern /^[A-Za-z0-9\\-_]+$/.");
        }
