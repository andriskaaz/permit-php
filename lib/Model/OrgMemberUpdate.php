...
/**
 * OrgMemberUpdate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrgMemberUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrgMemberUpdate';
    ...
    */
     ...
     * Sets settings
     *
     * @param object|null $settings Custom permit.io dashboard settings, such as preferred theme, etc.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\OnboardingStep|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\OnboardingStep|null $onboarding_step updates the onboarding step (optional)
     *
     * @return self
     */
