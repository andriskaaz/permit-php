...
/**
 * ResourceRoleRead Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResourceRoleRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResourceRoleRead';
    ...
    protected static $openAPITypes = [
        ...
        'attributes' => 'object',
        'extends' => 'string[]',
        'granted_to' => '\OpenAPI\Client\Model\DerivedRoleBlockRead',
        'key' => 'string',
        'id' => 'string',
    ...
    */
     ...
     * Gets granted_to
     *
     * @return \OpenAPI\Client\Model\DerivedRoleBlockRead|null
     */
     ...
     * Sets granted_to
     *
     * @param \OpenAPI\Client\Model\DerivedRoleBlockRead|null $granted_to Derived role that inherit will be applied on this role
     *
     * @return self
     */
     ...
     * Sets resource_id
     *
     * @param string $resource_id Unique id of the resource that the role belongs to.
     *
     * @return self
     */
     ...
     * Sets resource
     *
     * @param string $resource The unique resource key that the role belongs to.
     *
     * @return self
     */
