...
/**
 * EnvironmentStatistics Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EnvironmentStatistics implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EnvironmentStatistics';
    ...
    protected static $openAPITypes = [
        ...
        'members' => '\OpenAPI\Client\Model\OrgMemberReadWithGrants[]',
        'mau' => 'int'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['mau'] === null) {
            $invalidProperties[] = "'mau' can't be null";
        }
        if (($this->container['mau'] < 0)) {
    ...
    public function setRoles($roles)
    {
        ...
        if (($roles < 0)) {
            throw new \InvalidArgumentException('invalid value for $roles when calling EnvironmentStatistics., must be bigger than or equal to 0.');
        }
    ...
    public function setUsers($users)
    {
        ...
        if (($users < 0)) {
            throw new \InvalidArgumentException('invalid value for $users when calling EnvironmentStatistics., must be bigger than or equal to 0.');
        }
    ...
    public function setPolicies($policies)
    {
        ...
        if (($policies < 0)) {
            throw new \InvalidArgumentException('invalid value for $policies when calling EnvironmentStatistics., must be bigger than or equal to 0.');
        }
    ...
    public function setResources($resources)
    {
        ...
        if (($resources < 0)) {
            throw new \InvalidArgumentException('invalid value for $resources when calling EnvironmentStatistics., must be bigger than or equal to 0.');
        }
    ...
    public function setTenants($tenants)
    {
        ...
        if (($tenants < 0)) {
            throw new \InvalidArgumentException('invalid value for $tenants when calling EnvironmentStatistics., must be bigger than or equal to 0.');
        }
     ...
     * Gets members
     *
     * @return \OpenAPI\Client\Model\OrgMemberReadWithGrants[]
     */
     ...
     * Sets members
     *
     * @param \OpenAPI\Client\Model\OrgMemberReadWithGrants[] $members members
     *
     * @return self
     */
    ...
    public function setMau($mau)
    {
        ...
        if (($mau < 0)) {
            throw new \InvalidArgumentException('invalid value for $mau when calling EnvironmentStatistics., must be bigger than or equal to 0.');
        }
