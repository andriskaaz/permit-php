...
/**
 * AccessRequestCanceled Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AccessRequestCanceled implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccessRequestCanceled';
    ...
    protected static $openAPITypes = [
        ...
        'access_request_details' => '\OpenAPI\Client\Model\AccessRequestDetails',
        'reason' => 'string',
        'id' => 'string',
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\AccessRequestDetails
     */
     ...
     *
     * @param \OpenAPI\Client\Model\AccessRequestDetails $access_request_details details of the access request, including the resource and tenant
     *
     * @return self
     */
     ...
     * Sets reason
     *
     * @param string|null $reason Optional business justification provided by the user requesting access
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id Unique id of the access request
     *
     * @return self
     */
     ...
     *
     * @param string $organization_id Unique id of the organization that the access request belongs to.
     *
     * @return self
     */
     ...
     * Sets project_id
     *
     * @param string $project_id Unique id of the project that the access request belongs to.
     *
     * @return self
     */
     ...
     * Sets environment_id
     *
     * @param string $environment_id Unique id of the environment that the access request belongs to.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at Date and time when the access request was created (ISO_8601 format).
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime $updated_at Date and time when the access request was last updated/modified (ISO_8601 format).
     *
     * @return self
     */
     ...
     *
     * @param string|null $requesting_user_id optional id of the user that is requesting the access
     *
     * @return self
     */
     ...
     * Sets reviewed_at
     *
     * @param \DateTime|null $reviewed_at when the access request was reviewed
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\RequestStatus $status current status of the access request
     *
     * @return self
     */
     ...
     *
     * @param string|null $reviewer_user_id Optional id of the user who review the access request
     *
     * @return self
     */
