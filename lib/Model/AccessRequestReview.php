...
/**
 * AccessRequestReview Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AccessRequestReview implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccessRequestReview';
    ...
    */
     ...
     * Sets role
     *
     * @param string|null $role role id or key that the user is requesting access to
     *
     * @return self
     */
