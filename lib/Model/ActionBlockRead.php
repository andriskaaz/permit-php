...
/**
 * ActionBlockRead Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ActionBlockRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActionBlockRead';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name a more descriptive name for the action
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description optional description string explaining what this action represents in your system
     *
     * @return self
     */
