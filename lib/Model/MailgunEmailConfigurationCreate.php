...
/**
 * MailgunEmailConfigurationCreate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MailgunEmailConfigurationCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MailgunEmailConfigurationCreate';
    ...
    */
    ...
    public function setDomain($domain)
    {
        ...
        if ((mb_strlen($domain) > 65536)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling MailgunEmailConfigurationCreate., must be smaller than or equal to 65536.');
        }
        if ((mb_strlen($domain) < 1)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling MailgunEmailConfigurationCreate., must be bigger than or equal to 1.');
        }
