...
class UserData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param array<string,string[]> $role_assignments Key-Value mapping of the roles assigned to the user. The key is the tenant key and the value is a list of role keys assigned to the user in that tenant.
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets attributes
     *
     * @param object $attributes Key-Value mapping of the attributes of the user. The key is the attribute key and the value is the attribute value.
     *
     * @return self
     */
