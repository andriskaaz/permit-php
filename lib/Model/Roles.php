...
class Roles implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setTotalCount($total_count)
    {
        ...
        if (($total_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_count when calling Roles., must be bigger than or equal to 0.');
        }
    ...
    public function setPageCount($page_count)
    {
        ...
        if (($page_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $page_count when calling Roles., must be bigger than or equal to 0.');
        }
