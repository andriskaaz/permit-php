...
class ResourceUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResourceUpdate';
    ...
    */
     ...
     * Gets actions
     *
     * @return array<string,\OpenAPI\Client\Model\ActionBlockEditable>|null
     */
     ...
     * Sets actions
     *
     * @param array<string,\OpenAPI\Client\Model\ActionBlockEditable>|null $actions A actions definition block, typically contained within a resource type definition block.         The actions represents the ways you can interact with a protected resource.
     *
     * @return self
     */
