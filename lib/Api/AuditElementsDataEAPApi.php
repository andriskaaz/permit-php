...
/**
 * AuditElementsDataEAPApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class AuditElementsDataEAPApi
{
    ...
    public function elementsListAuditLogsRequest($proj_id, $env_id, $elements_config_id, $search = null, $page = 1, $per_page = 30, string $contentType = self::contentTypes['elementsListAuditLogs'][0])
    {
        ...
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling AuditElementsDataEAPApi.elementsListAuditLogs, must be bigger than or equal to 1.');
        }
        
        if ($per_page !== null && $per_page > 100) {
            throw new \InvalidArgumentException('invalid value for "$per_page" when calling AuditElementsDataEAPApi.elementsListAuditLogs, must be smaller than or equal to 100.');
        }
        if ($per_page !== null && $per_page < 1) {
            throw new \InvalidArgumentException('invalid value for "$per_page" when calling AuditElementsDataEAPApi.elementsListAuditLogs, must be bigger than or equal to 1.');
        }
