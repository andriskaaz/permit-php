...
/**
 * SSHAuthDataRead Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SSHAuthDataRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SSHAuthDataRead';
    ...
    public const AUTH_TYPE_SSH = 'ssh';
    ...
    {
        $this->setIfExists('auth_type', $data ?? [], 'ssh');
    ...
    */
     ...
     * Sets public_key
     *
     * @param string|null $public_key SSH public key
     *
     * @return self
     */
     ...
     * Sets private_key
     *
     * @param string $private_key SSH private key
     *
     * @return self
     */
