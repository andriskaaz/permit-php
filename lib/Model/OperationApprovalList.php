...
/**
 * OperationApprovalList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OperationApprovalList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OperationApprovalList';
    ...
    protected static $openAPIFormats = [
        ...
        'requesting_user_first_name' => null,
        'requesting_user_last_name' => null,
        'resource_key' => null,
        'resource_instance_key' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'requesting_user_email' => false,
        'requesting_user_first_name' => false,
        'requesting_user_last_name' => false,
        'resource_key' => false,
        'resource_instance_key' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'requesting_user_last_name' => 'requesting_user_last_name',
    ...
    protected static $setters = [
        ...
        'requesting_user_email' => 'setRequestingUserEmail',
        'requesting_user_first_name' => 'setRequestingUserFirstName',
        'requesting_user_last_name' => 'setRequestingUserLastName',
        'resource_key' => 'setResourceKey',
        'resource_instance_key' => 'setResourceInstanceKey'
    ];
    ...
    protected static $getters = [
        ...
        'requesting_user_email' => 'getRequestingUserEmail',
        'requesting_user_first_name' => 'getRequestingUserFirstName',
        'requesting_user_last_name' => 'getRequestingUserLastName',
        'resource_key' => 'getResourceKey',
        'resource_instance_key' => 'getResourceInstanceKey'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('requesting_user_email', $data ?? [], null);
        $this->setIfExists('requesting_user_first_name', $data ?? [], null);
        $this->setIfExists('requesting_user_last_name', $data ?? [], null);
        $this->setIfExists('resource_key', $data ?? [], null);
        $this->setIfExists('resource_instance_key', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets requesting_user_email
     *
     * @return string|null
     */
    public function getRequestingUserEmail()
    {
        return $this->container['requesting_user_email'];
    }

    /**
     * Sets requesting_user_email
     *
     * @param string|null $requesting_user_email email of the user that is requesting the approval
     *
     * @return self
     */
    public function setRequestingUserEmail($requesting_user_email)
    {
        if (is_null($requesting_user_email)) {
            throw new \InvalidArgumentException('non-nullable requesting_user_email cannot be null');
        }
        $this->container['requesting_user_email'] = $requesting_user_email;

        return $this;
    }

    /**
     * Gets requesting_user_first_name
     *
     * @return string|null
     */
    public function getRequestingUserFirstName()
    {
        return $this->container['requesting_user_first_name'];
    }

    /**
     * Sets requesting_user_first_name
     *
     * @param string|null $requesting_user_first_name first name of the user that is requesting the approval
     *
     * @return self
     */
    public function setRequestingUserFirstName($requesting_user_first_name)
    {
        if (is_null($requesting_user_first_name)) {
            throw new \InvalidArgumentException('non-nullable requesting_user_first_name cannot be null');
        }
        $this->container['requesting_user_first_name'] = $requesting_user_first_name;

        return $this;
    }

    /**
     * Gets requesting_user_last_name
     *
     * @return string|null
     */
    public function getRequestingUserLastName()
    {
        return $this->container['requesting_user_last_name'];
    }

    /**
     * Sets requesting_user_last_name
     *
     * @param string|null $requesting_user_last_name last name of the user that is requesting the approval
     *
     * @return self
     */
    public function setRequestingUserLastName($requesting_user_last_name)
    {
        if (is_null($requesting_user_last_name)) {
            throw new \InvalidArgumentException('non-nullable requesting_user_last_name cannot be null');
        }
        $this->container['requesting_user_last_name'] = $requesting_user_last_name;
     ...
     * Sets resource_key
     *
     * @param string|null $resource_key key of the resource that the user is requesting operation approval for
     *
     * @return self
     */
    public function setResourceKey($resource_key)
    {
        if (is_null($resource_key)) {
            throw new \InvalidArgumentException('non-nullable resource_key cannot be null');
        }
    ...
    /**
     * Gets resource_instance_key
     *
     * @return string|null
     */
    public function getResourceInstanceKey()
    {
        return $this->container['resource_instance_key'];
    }

    /**
     * Sets resource_instance_key
     *
     * @param string|null $resource_instance_key key of the resource instance that the user is requesting operation approval for
     *
     * @return self
     */
    public function setResourceInstanceKey($resource_instance_key)
    {
        if (is_null($resource_instance_key)) {
            throw new \InvalidArgumentException('non-nullable resource_instance_key cannot be null');
        }
        $this->container['resource_instance_key'] = $resource_instance_key;
