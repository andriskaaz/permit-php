...
class RoleRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets granted_to
     *
     * @param \OpenAPI\Client\Model\DerivedRoleBlockRead|null $granted_to A derived role defintion block, typically contained whithin a role definition.         The derived role is a role that is derived from the role definition.
     *
     * @return self
     */
