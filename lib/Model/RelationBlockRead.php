...
/**
 * RelationBlockRead Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RelationBlockRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RelationBlockRead';
    ...
    */
     ...
     * Sets resource_id
     *
     * @param string $resource_id Unique id of the relation
     *
     * @return self
     */
     ...
     * Sets relation_name
     *
     * @param string|null $relation_name a more descriptive name for the relation
     *
     * @return self
     */
