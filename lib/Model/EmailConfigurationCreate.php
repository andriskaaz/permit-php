...
/**
 * EmailConfigurationCreate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EmailConfigurationCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = 'email_provider_type';
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailConfigurationCreate';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['email_provider_type'] = static::$openAPIModelName;
    }
    ...
    */
    ...
    public function setDomain($domain)
    {
        ...
        if ((mb_strlen($domain) > 65536)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling EmailConfigurationCreate., must be smaller than or equal to 65536.');
        }
        if ((mb_strlen($domain) < 1)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling EmailConfigurationCreate., must be bigger than or equal to 1.');
        }
