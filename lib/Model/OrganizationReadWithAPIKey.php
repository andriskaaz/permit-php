...
/**
 * OrganizationReadWithAPIKey Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrganizationReadWithAPIKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrganizationReadWithAPIKey';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('api_key_secret', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($api_key_secret)) {
            throw new \InvalidArgumentException('non-nullable api_key_secret cannot be null');
        }
