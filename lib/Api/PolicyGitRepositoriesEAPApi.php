...
/**
 * PolicyGitRepositoriesEAPApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PolicyGitRepositoriesEAPApi
{
    /**
     * @var ClientInterface
     */
    ...
    public function createPolicyRepoRequest($proj_id, $policy_repo_create, string $contentType = self::contentTypes['createPolicyRepo'][0])
    {
        ...
        if (isset($policy_repo_create)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($policy_repo_create));
            } else {
    ...
    public function listPolicyReposRequest($proj_id, $page = 1, $per_page = 30, string $contentType = self::contentTypes['listPolicyRepos'][0])
    {
        ...
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling PolicyGitRepositoriesEAPApi.listPolicyRepos, must be bigger than or equal to 1.');
        }
        
        if ($per_page !== null && $per_page > 100) {
            throw new \InvalidArgumentException('invalid value for "$per_page" when calling PolicyGitRepositoriesEAPApi.listPolicyRepos, must be smaller than or equal to 100.');
        }
        if ($per_page !== null && $per_page < 1) {
            throw new \InvalidArgumentException('invalid value for "$per_page" when calling PolicyGitRepositoriesEAPApi.listPolicyRepos, must be bigger than or equal to 1.');
        }
