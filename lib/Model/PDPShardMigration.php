...
/**
 * PDPShardMigration Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PDPShardMigration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PDPShardMigration';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['num_shards'] === null) {
            $invalidProperties[] = "'num_shards' can't be null";
        }
     ...
     * Sets num_shards
     *
     * @param int $num_shards num_shards
     *
     * @return self
     */
