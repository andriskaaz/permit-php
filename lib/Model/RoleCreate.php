 ...
 */
class RoleCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RoleCreate';
    ...
    */
    ...
    public function setKey($key)
    {
        ...
        if ((!preg_match("/^[A-Za-z0-9\\-_]+$/", ObjectSerializer::toString($key)))) {
            throw new \InvalidArgumentException("invalid value for \$key when calling RoleCreate., must conform to the pattern /^[A-Za-z0-9\\-_]+$/.");
        }
