    ...
    */
    ...
    public function setRedirectTo($redirect_to)
    {
        ...
        if ((mb_strlen($redirect_to) > 65536)) {
            throw new \InvalidArgumentException('invalid length for $redirect_to when calling EmailTemplateUpdate., must be smaller than or equal to 65536.');
        }
        if ((mb_strlen($redirect_to) < 1)) {
            throw new \InvalidArgumentException('invalid length for $redirect_to when calling EmailTemplateUpdate., must be bigger than or equal to 1.');
        }
