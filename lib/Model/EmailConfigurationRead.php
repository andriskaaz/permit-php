...
/**
 * EmailConfigurationRead Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EmailConfigurationRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailConfigurationRead';
    ...
    */
    ...
    public function setDomain($domain)
    {
        ...
        if ((mb_strlen($domain) > 65536)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling EmailConfigurationRead., must be smaller than or equal to 65536.');
        }
        if ((mb_strlen($domain) < 1)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling EmailConfigurationRead., must be bigger than or equal to 1.');
        }
