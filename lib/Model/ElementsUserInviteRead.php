...
/**
 * ElementsUserInviteRead Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ElementsUserInviteRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ElementsUserInviteRead';
    ...
    */
    ...
    public function setKey($key)
    {
        ...
        if ((!preg_match("/^[A-Za-z0-9|@+\\-\\._]+$/", ObjectSerializer::toString($key)))) {
            throw new \InvalidArgumentException("invalid value for \$key when calling ElementsUserInviteRead., must conform to the pattern /^[A-Za-z0-9|@+\\-\\._]+$/.");
        }
