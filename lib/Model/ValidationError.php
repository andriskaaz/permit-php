...
class ValidationError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'loc' => '\OpenAPI\Client\Model\MappingRulesInnerValue[]',
        'msg' => 'string',
        'type' => 'string'
    ];
    ...
    */
     ...
     * Gets loc
     *
     * @return \OpenAPI\Client\Model\MappingRulesInnerValue[]
     */
     ...
     * Sets loc
     *
     * @param \OpenAPI\Client\Model\MappingRulesInnerValue[] $loc loc
     *
     * @return self
     */
