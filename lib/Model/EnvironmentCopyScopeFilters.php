...
/**
 * EnvironmentCopyScopeFilters Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EnvironmentCopyScopeFilters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EnvironmentCopyScopeFilters';
    ...
    */
     ...
     * Sets include
     *
     * @param string[]|null $include Objects to include (use * as wildcard)
     *
     * @return self
     */
     ...
     * Sets exclude
     *
     * @param string[]|null $exclude Object to exclude (use * as wildcard)
     *
     * @return self
     */
